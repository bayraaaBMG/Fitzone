  ...
  app.innerHTML = `
    ...
    <div class="view">
      ...
      <button class="btn g" id="au_google" style="margin-top:18px; display:flex; align-items:center; justify-content:center; gap:10px" ${authBusy?'disabled':''}>
        ...
        ${authBusy ? 'Түр хүлээнэ үү…' : 'Google-ээр үргэлжлүүлэх'}
      </button>
      <p class="xs mut center" style="margin:14px 0">эсвэл имэйлээр</p>
      <div class="field"><label>Имэйл</label><input class="txin" id="au_email" type="email" placeholder="tanii@mail.com" autocomplete="email" value="${esc(authDraft.email)}"></div>
