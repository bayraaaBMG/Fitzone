...
const I18N = {
  mn: {
    ...
    pose_face_camera:'Камер руугаа харан зогсоно уу',
    ...
    ws_cam_loading:'Camera болон pose model ачаалж байна…',
    ws_cam_on_auto:'Camera идэвхтэй — зөв хийсэн бүтэн давталт л автоматаар тоологдоно.',
    ws_cam_on_manual:'Camera идэвхтэй — энэ дасгалд автомат тоолол дэмжигдэхгүй тул давталтаа товчоор тоолно.',
    ws_cam_note_auto:'Энэ дасгалд camera-аар автомат тоолол, форм шалгалт хийж болно.',
    ws_cam_note_manual:'Энэ дасгалд camera зөвхөн биеийн байрлалыг харуулна; давталтыг товчоор тоолно.',
    ws_cam_privacy:'Видео зөвхөн таны төхөөрөмж дээр боловсруулагдаж, хаана ч илгээгдэхгүй.',
    ws_cam_accuracy:'Pose detection 100% нарийвчлалтай биш — гэрэл, байрлалаас хамаарна.',
    cam_err_denied:'Camera-ийн зөвшөөрөл өгөгдсөнгүй. Дасгал camera-гүйгээр бүрэн ажиллана.',
    cam_err_nocamera:'Camera олдсонгүй эсвэл өөр апп ашиглаж байна. Дасгал camera-гүйгээр бүрэн ажиллана.',
    cam_err_model:'Pose model ачаалж чадсангүй (сүлжээ шалгана уу). Дасгал camera-гүйгээр бүрэн ажиллана.',
    ws_get_ready:'Бэлдээрэй', ws_go:'ЭХЭЛ!', ws_count_hint:'Camera ашиглаж байгаа бол бие бүтэн харагдахаар байрлаарай.',
    ws_you:'Та', ws_time:'Хугацаа', ws_pause:'Зогсоох', ws_resume:'Үргэлжлүүлэх', ws_finish:'Дуусгах', ws_paused:'Түр зогссон',
    ws_auto_count:'Автомат тоолол', ws_undo:'−1', ws_holding:'Барьж байна',
    ws_rep_rejected:'Тоологдсонгүй — {0}', ws_confirm_quit:'Үр дүнг хадгалахгүйгээр гарах уу?',
    ws_you_win:'Та яллаа', ws_draw:'Тэнцлээ', ws_keep_going:'Үргэлжлүүлээрэй', ws_target_hit:'Зорилтод хүрлээ', ws_session_done:'Дасгал дууслаа',
    ws_msg_win:'Гайхалтай ажиллалаа!', ws_msg_lose:'Дараагийн удаа оноогоо ахиулахыг хичээгээрэй.',
    ws_msg_target_hit:'Маш сайн — зорилтоо биелүүллээ!', ws_msg_target_miss:'Сайн эхлэл — дараагийн удаа зорилтдоо ойртоно.',
    ws_done_reps:'{0} давталт хийлээ', ws_done_time:'{0} сек барилаа',
    ws_pr_first:'Анхны рекордоо тогтоолоо', ws_pr_up:'Хувийн рекорд +{0}', ws_pr_same:'Хувийн рекорд: {0}',
    ws_streak:'Streak: {0} өдөр', ws_streak_up:'Streak +1 → {0} өдөр',
    ws_form_score:'Форм оноо {0}%', ws_form_none:'Форм оноо: camera ашиглаагүй',
    ws_not_saved:'0 үр дүн тул хадгалагдсангүй.',
    ws_next_up:'Дараагийн сорилт: {0}', ws_next_down:'Эхлээд хялбар хувилбараар хүчээ нэмээрэй: {0}',
    ws_done:'Болсон', ws_again:'Дахин хийх',
    pf_records:'Хувийн рекордууд', pf_no_records:'Одоогоор рекорд алга — дасгалын дэлгэрэнгүйгээс "Дасгал эхлүүлэх" дарж эхлээрэй.',

    /* pose feedback */
    pose_good:'Зөв байна ✓', pose_ready:'Байрлал бэлэн ✓', pose_low_conf:'Байрлалыг тодорхойлоход хэцүү байна',
    pose_tracking_manual:'Бие харагдаж байна — давталтаа товчоор тоол', pose_get_in_position:'Дасгалын эхлэх байрлалд ороорой',
    pose_hips_sag:'Бэлхүүсээ бүү унжуул — биеэ шулуун барь', pose_hips_up:'Өгзгөө доош буулгаж биеэ шулуун барь',
    pose_go_lower:'Цээжээ арай доош буулгаарай', pose_pike_hips:'Өгзгөө илүү өндөр өргө',
    pose_squat_lower:'Доошоо арай илүү суугаарай', pose_chest_up:'Цээжээ өргө — урагш бүү бөхий',
    pose_knees_out:'Өвдгөө хөлийн хурууны чигт барь', pose_lunge_lower:'Хойд өвдгөө шал руу илүү буулга',
    pose_torso_upright:'Их биеэ босоо барь', pose_hips_higher:'Аарцгаа бүрэн өргө',
    pose_hinge_lower:'Хипээ хойш түлхэж илүү нугал', pose_soft_knees:'Өвдгөө хэт бүү нугал',
    pose_press_full:'Гараа толгойн дээр бүрэн тэнийлгэ', pose_no_arch:'Бэлхүүсээ хойш бүү хотойлго',
  ...
  en: {
    ...
    pose_face_camera:'Stand facing the camera',
    ...
    ws_cam_loading:'Loading camera and pose model…',
    ws_cam_on_auto:'Camera on — only full reps with good form are counted automatically.',
    ws_cam_on_manual:'Camera on — auto-count isn’t supported for this exercise, so count reps with the button.',
    ws_cam_note_auto:'This exercise supports camera auto-counting and form checks.',
    ws_cam_note_manual:'For this exercise the camera only shows your body position; reps are counted with the button.',
    ws_cam_privacy:'Video is processed only on your device and never uploaded.',
    ws_cam_accuracy:'Pose detection is not 100% accurate — it depends on lighting and positioning.',
    cam_err_denied:'Camera permission was not granted. The exercise works fully without the camera.',
    cam_err_nocamera:'No camera found, or it is in use by another app. The exercise works fully without the camera.',
    cam_err_model:'Couldn’t load the pose model (check your connection). The exercise works fully without the camera.',
    ws_get_ready:'Get ready', ws_go:'GO!', ws_count_hint:'Using the camera? Make sure your whole body is in view.',
    ws_you:'You', ws_time:'Time', ws_pause:'Pause', ws_resume:'Resume', ws_finish:'Finish', ws_paused:'Paused',
    ws_auto_count:'Auto-count', ws_undo:'−1', ws_holding:'Holding',
    ws_rep_rejected:'Not counted — {0}', ws_confirm_quit:'Leave without saving this result?',
    ws_you_win:'You win', ws_draw:'Draw', ws_keep_going:'Keep going', ws_target_hit:'Target reached', ws_session_done:'Workout complete',
    ws_msg_win:'Excellent work!', ws_msg_lose:'Try to beat your score next time.',
    ws_msg_target_hit:'Great job — target reached!', ws_msg_target_miss:'Good start — you’ll get closer next time.',
    ws_done_reps:'{0} reps completed', ws_done_time:'{0} seconds held',
    ws_pr_first:'First record set', ws_pr_up:'Personal record +{0}', ws_pr_same:'Personal record: {0}',
    ws_streak:'Streak: {0} days', ws_streak_up:'Streak +1 → {0} days',
    ws_form_score:'Form score {0}%', ws_form_none:'Form score: camera not used',
    ws_not_saved:'Nothing was saved for a 0 result.',
    ws_next_up:'Next challenge: {0}', ws_next_down:'Build strength with an easier variation first: {0}',
    ws_done:'Done', ws_again:'Do it again',
    pf_records:'Personal records', pf_no_records:'No records yet — open any exercise and tap "Start exercise".',

    /* pose feedback */
    pose_good:'Good form ✓', pose_ready:'Position ready ✓', pose_low_conf:'Hard to detect your position',
    pose_tracking_manual:'Body in view — count reps with the button', pose_get_in_position:'Get into the starting position',
    pose_hips_sag:'Don’t let your hips sag — keep your body straight', pose_hips_up:'Lower your hips and keep a straight line',
    pose_go_lower:'Lower your chest a bit more', pose_pike_hips:'Lift your hips higher',
    pose_squat_lower:'Sit down a little deeper', pose_chest_up:'Chest up — don’t lean forward',
    pose_knees_out:'Keep your knees in line with your toes', pose_lunge_lower:'Lower your back knee closer to the floor',
    pose_torso_upright:'Keep your torso upright', pose_hips_higher:'Lift your hips all the way up',
    pose_hinge_lower:'Push your hips back and hinge deeper', pose_soft_knees:'Don’t bend your knees too much',
    pose_press_full:'Press all the way overhead', pose_no_arch:'Don’t arch your lower back',
